...
cp -r css images js _out/
for f in about.html privacy.html terms.html support.html guidelines.html fediverse.html donate.html verified.html child-safety.html; do
  [ -f "$f" ] && cp "$f" _out/
done
